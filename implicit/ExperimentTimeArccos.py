...
if __name__ == '__main__':
    ...
    for i in range(10):
        ...
        n.trainFunction(dg4, 2000, max(1,dataSize/200), 200, "gradient", useMultiprocessing = True, saveState = True, saveStateSteps = 5, trackHighestProb = True, plot = True, plotName = "arccosPlot")
